...
<center><div class="navbar navbar-fixed-top <?php echo $nav_class?>" id="navbar_top" style="text-align:center">
<div class="navbar navbar-inner" style="padding:0;text-align:center">
	...
	<div class="navbar navbar-inner visible-phone" style="text-align:center;padding:0;width:100%;position:fixed;z-index:3;top:0px;margin:0px">
        <div class="container-fluid navbar-padding-fix">
		    <a class="btn <?php echo $button_class?> visible-phone pull-left" href="javascript:history.back(-1);" style="margin-left:10px">
          ...
          <div class="brand" style="float:none;display:inline-block;margin-left:auto;margin-right:auto"><?php echo"$inTitle";?></div>
            <a class="btn <?php echo $button_class?> pull-right" style="margin-right:10px" data-toggle="collapse" data-target=".nav-collapse">
            <i class="icon-th-list"></i><strong class="notifier"></strong></a>
