		...
		<div class="container-fluid">
			...
			<div class="row-fluid">
				<div class="span2 offset2 form-inline">
					<span id="sendnew" style="margin:5px" class="btn btn-medium shortcut-hint" title="Alt+N"><i class="icon-inbox"></i> 新建... </span>
				...
				<div class="span8 offset2" id="maillist">
						...
						?>
								<div class="mail-container">
									...
									<div class="mail-info"><?php echo $row[2],' 日期: ',substr($row[4],0,10);?></div>
					...
					<form class="form-horizontal" id="send_form">
						<fieldset>
							<div class="control-group">
								<label class="control-label" for="to_input">收信人</label>
								<div class="controls">
									<input type="text" class="input-medium" id="to_input" name="touser">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="title_input">主题</label>
								<div class="controls">
