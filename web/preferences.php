				...
				<?php }else{?>
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12">
								<?php
									echo _('Here you can download your last accepted submit of every problem. However, you can execute this not more than once a week.');
									if(!is_null($pref->backuptime))
										echo "<br><strong>最近一次备份时间: ",date('Y-m-d H:i:s', $pref->backuptime),"</strong>";
								?>
								<br>
								<button class="btn btn-default" id="download_btn" style="margin-top:8px"><?php echo _('Backup & Download')?></button>
							</div>
						</div>
