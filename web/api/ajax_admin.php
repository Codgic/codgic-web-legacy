...
if($op=="list_usr"){
    ...
    $addt_cond='';
    /*Fliter: to be finished...*/
    $res=mysqli_query($con,"select user_id,accesstime,solved,submit,accesstime,email,privilege,nick from users where (user_id like '%$keyword%' or nick like '%$keyword%') $addt_cond order by privilege desc,user_id limit $page_id,20");
...
if(!isset($_POST['title'])||!isset($_POST['content']))
    ...
    if($priv!=0) $priv+=PRIV_SYSTEM; //System always has the privilege.
