...
exit();
        ...
        echo json_encode(array('success' => false, 'message' => 'Invalid argument.'));
exit();
    }
    ...
    if($_POST['op']=='del'){
        if(!isset($_POST['problem_id'])){
            echo json_encode(array('success' => false, 'message' => 'No such problem.'));
exit();
        }
        ...
        if($row=mysqli_fetch_row($result)){
            if($row[0]=='N') $opr='Y';
                ...
                if(mysqli_query($con,"update problem set defunct='$opr' where problem_id=$id"))
                    ...
                    echo json_encode(array('success' => false, 'message' => 'DB operation failed.'));
        }
    }else{
